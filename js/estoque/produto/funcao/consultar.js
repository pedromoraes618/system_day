...
$("#grupo_estoque").change(function() {
    ...
    function sucesso(data) {
        ...
        if ($dados.sucesso) {
            if(campo_estoque.value ==""){ // verificar se o campo está preenchido, se estiver não alterar
                campo_estoque.value = $dados.estoque_inicial
            }
            if(campo_estoque_minimo.value ==""){
                campo_estoque_minimo.value = $dados.estoque_minimo
            }
            if(campo_estoque_maximo.value == ""){
                campo_estoque_maximo.value = $dados.estoque_maximo
            }
            if(campo_local.value ==""){
                campo_local.value = $dados.local
            }
            if(campo_unidade_md.value =="0"){
