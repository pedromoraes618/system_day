...
$("#adicionar_lancamento_financeiro").click(function () {
    $.ajax({
        type: 'GET',
        data: "adicionar_lancamento_financeiro=true",
...
if (localStorage.getItem("storage_pesquisa")) {
    ...
    $.ajax({
        type: 'GET',
        data: "consultar_lancamento_financeiro=detalhado&conteudo_pesquisa=" + conteudo_pesquisa.value + "&data_inicial="+data_inicial.value+"&data_final="+data_final.value,
