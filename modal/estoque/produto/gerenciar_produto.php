...
include "../../../../funcao/funcao.php";
        ...
        if($consulta== "inicial"){
            ...
            $select = "SELECT prd.cl_id as produtoid,prd.cl_descricao as descricao,prd.cl_referencia,prd.cl_status_ativo as ativo, subgrp.cl_descricao as subgrupo,und.cl_sigla as und,frb.cl_descricao as fabricante,prd.cl_estoque,prd.cl_preco_venda 
...
if(isset($_POST['formulario_cadastrar_produto'])){
    ...
    include "../../../funcao/funcao.php";
        ...
        $inset = "INSERT INTO tb_produtos (cl_data_cadastro,cl_descricao,cl_tamanho,cl_localizacao,cl_referencia,cl_codigo_barra,cl_observacao,cl_preco_custo,cl_preco_venda,
        cl_preco_promocao,cl_desconto_maximo,cl_margem_lucro,cl_cest,cl_ncm,cl_cst_icms,cl_cst_pis_s,cl_cst_pis_e,cl_cst_cofins_s,cl_cst_cofins_e,cl_estoque,
        cl_estoque_minimo,cl_estoque_maximo,cl_cfop_interno,cl_cfop_externo,cl_equivalencia,cl_fabricante_id,cl_und_id,cl_grupo_id,cl_tipo_id,cl_status_ativo)
         VALUES ('$data_lancamento','$descricao','$tamanho','$local_produto','$referencia','$codigo_barras','$observacao','$prc_custo','$prc_venda',
         '$prc_promocao','$desconto_maximo','$margem_lucro','$cest','$ncm','$cst_icms','$cst_pis_s','$cst_pis_e','$cst_cofins_s','$cst_cofins_e','$estoque',
        ...
        $cd_produto_b = $linha['id'];

         $retornar["dados"] =array("sucesso"=>true,"title"=>"cadastro realizado com sucesso, código do produto $cd_produto_b");
        //registrar no log
        $mensagem =  (utf8_decode("Usúario") . " $nome_usuario_logado cadastrou o produto de codigo $cd_produto_b");
