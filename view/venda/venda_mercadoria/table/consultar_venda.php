...
?>
    <table class="table table-hover">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <th scope="row"><?php echo formatDateB($data_movimento_b) ?></td>
                    ...
                    <td class="td-btn"><button type="button" venda_mercadoria_id="<?php echo $id_b; ?>" class="btn btn-info   btn-sm editar_venda_mercadoria">Editar</button>
                    </td>
