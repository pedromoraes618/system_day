    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            <?php while($linha  = mysqli_fetch_assoc($buscar_cep)){ 
                            ...
                            echo "<tr><td>$cest_b</td><td>$ncm_b</td><td>$descricao</td><td><button type='button' valor='$cest_b' class='selecionar_cest btn btn-sm btn-danger'>Selecionar</button></td></tr>";
