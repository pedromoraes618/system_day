            ...
            <div class="group-bloco">
                ...
                <form id="formulario_resetar_senha">
                    <div class="group-input">
                        ...
                        <div class="gp-input">
                            <input type="hidden" class="form-control" id="post_resetar_senha" name="post_resetar_senha">
                        </div>
                        <div class="gp-input">
                            <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Usuário">
                        </div>
                        <div class="gp-input">
                            <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha atual">
                        </div>
                        <div class="gp-input">
