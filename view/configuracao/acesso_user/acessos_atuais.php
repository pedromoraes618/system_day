...
inner join tb_categorias as ctg on ctg.cl_id = subc.cl_categoria where  cl_usuario_id = '$usuario_id' and acess.cl_acesso_ativo = '1' group by categoria";
    ...
    <li><?php echo $categoria ?>
        <ul>
            ...
            <li id="<?php echo $subcategoria_id; ?>">
                <p><?php echo $subcategoria; ?></p><a id="<?php echo $subcategoria_id; ?>">Remover</a>
            </li>
            <?php 
            }
            ?>
