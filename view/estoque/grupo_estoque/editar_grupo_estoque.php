...
<form id="editar_grupo_estoque">
    ...
    <div class="row">
        <div class="col-sm">
            <div title="os produtos que estão incluidos nesse grupo pertencem ao modulo de vendas"
                class="form-check form-check-inline">
                <input class="form-check-input" <?php if($grupo_venda_b==1){echo "checked";} ?>  type="checkbox" id="grupo_venda" name="grupo_venda">
                <label class="form-check-label" for="grupo_venda">Grupo para venda</label>
            </div>
            <div title="os produtos que estão incluidos nesse grupo pertencem ao modulo de serviços"
                class="form-check form-check-inline">
                <input class="form-check-input" <?php if($grupo_servico_b==1){echo "checked";} ?>  type="checkbox" id="grupo_servico" name="grupo_servico">
